...
/// Generates app icons with a "DEMO" watermark banner for Iconomizer
/// Banner stays within icon bounds for macOS Tahoe compatibility
/// Usage: swift GenerateDemoIcons-Iconomizer.swift

let fileManager = FileManager.default

// Paths for Iconomizer project
let assetsDir = URL(fileURLWithPath: "/Users/cbruno/Documents/GitHub/Iconomizer/Iconomizer/Assets.xcassets")
...
for iconFile in iconFiles {
    ...
    // Create demo filename by prefixing with "demo_"
    let demoFilename = "demo_" + filename
